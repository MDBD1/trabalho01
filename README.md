...
> 	O "TimeBus" é um sistema proposto pela "Neworld" que visa facilitar o tráfego de passageiros que utiliza o ônibus como meio de transporte. Inicialmente para realizar o cadastro o sistema irá solicitar aos usuários algumas informações como nome, endereço e seu e-mail que será seguido de uma senha para efetuar o cadastro. O sistema também irá ler as as informações referentes aos pontos de ônibus como o número do ponto, seu endereço e as empresas que possuem ônibus que passem pelos mesmos pontos. Passado isso, o sistema irá ler as informações referentes ao próprio ônibus como n° do ônibus, número da linha, horário(chegada e saída) e seu itinerário. Desse modo o "TimeBus" poderá providenciar informações como os pontos de ônibus mais próximos do local atual e os locais onde estão ocorrendo engarrafamentos, consequentemente, o usuário poderá selecionar um ônibus que passe pela melhor rota e ter um transporte mais rápido para chegar em seu destino. 
...
![Alt text](https://github.com/MDBD1/trabalho01/blob/master/imagens/up1.png)<br>
